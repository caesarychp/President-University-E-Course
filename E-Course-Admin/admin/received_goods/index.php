            ...
            <div class="container-fluid">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $qry = $conn->query("SELECT rg.receive_id, po.po_id, po.po_no, po.material_id, po.date_created AS order_date, rg.employee_id, e.name AS recipient_name, rg.due_date, rg.received_date, rg.status FROM `receive_goods` rg JOIN `purchase_order` po ON rg.po_id = po.po_id LEFT JOIN `employees` e ON rg.employee_id = e.employee_id WHERE po.status = 1 ORDER BY rg.received_date ASC");
