			...
			<div class="container-fluid">
				<table class="table table-hover table-striped">
					...
					<tbody>
						<?php
						$i = 1;
						$qry = $conn->query("SELECT * from `vendor` order by (`date_created`) asc ");
...
<script>
	$(document).ready(function() {
		...
		$('#create_new').click(function() {
			uni_modal("<i class='fa fa-plus'></i> Register New vendor", "vendor/manage_vendor.php")
		})
		$('.view_data').click(function() {
			uni_modal("<i class='fa fa-info-circle'></i> vendor's Details", "vendor/view_details.php?id=" + $(this).attr('data-id'), "")
		})
		$('.edit_data').click(function() {
			uni_modal("<i class='fa fa-edit'></i> Edit vendor's Details", "vendor/manage_vendor.php?id=" + $(this).attr('data-id'))
		})
