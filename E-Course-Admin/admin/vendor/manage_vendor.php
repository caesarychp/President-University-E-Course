...
<form action="" id="vendor-form">
    <input type="hidden" name="id" value="<?php echo isset($vendor_id) ? $vendor_id : '' ?>">
    <div class="container-fluid">
        <div class="form-group">
            <label for="name" class="control-label">vendor Name</label>
            <input type="text" name="vendor_name" id="vendor_name" class="form-control rounded-0" value="<?php echo isset($vendor_name) ? $vendor_name : "" ?>" required>
        </div>
        <div class="form-group">
