...
if (isset($_GET['id']) && $_GET['id'] > 0) {
    $po_id_from_url = $_GET['id']; // Retrieve the po_id from the URL parameter
    $qry = $conn->query("SELECT * FROM `purchase_order` WHERE po_id = '$po_id_from_url'");
    if ($qry->num_rows > 0) {
        $purchase_order = $qry->fetch_assoc();
        $vendor_id = $purchase_order['vendor_id']; // Retrieve vendor_id from fetched data
    }
}
?>
                    ...
                    <table class="table table-striped table-bordered" id="item-list">
                        ...
                        <tbody>
                            ...
                            if (isset($purchase_order)) :
                                $po_id = $purchase_order['po_id']; // Get the po_id from the fetched data
                            ...
                            ?>
                                    ...
                                    <tr class="po-item" data-id="">
                                        ...
                                        <input type="hidden" name="po_id" value="<?php echo $po_id_from_url; ?>">
            ...
            $.ajax({
                ...
                success: function(resp) {
                    if (typeof resp == 'object' && resp.status == 'success') {
                        location.href = "./?page=purchase_orders/view_po&po_id=" + resp.id;
