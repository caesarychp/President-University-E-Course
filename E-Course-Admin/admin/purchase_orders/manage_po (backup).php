                ...
                <div class="col-md-12">
                    <table class="table table-striped table-bordered" id="item-list">
                        ...
                        <tbody>
                            <?php
                            if (isset($id)) {
                                $order_items_qry = $conn->query("SELECT o.material_id, m.material_name, o.quantity, o.price FROM `purchase_order` o INNER JOIN `material` m ON o.material_id = m.material_id WHERE o.po_id = '$id'");
                                echo $conn->error;
                            ...
                            ?>
                                    <tr class="po-item" data-id="">
                                        ...
                                        <td class="align-middle p-1 text-center"><?php echo $row['material_id']; ?></td>
                                        <td class="align-middle p-1 text-center"><?php echo $row['material_name']; ?></td>
