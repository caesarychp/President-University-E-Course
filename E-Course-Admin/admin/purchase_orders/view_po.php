...
<div class="card card-outline card-info">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <a class="btn btn-sm btn-flat btn-primary" href="?page=purchase_orders/manage_po&id=<?php echo $po_id ?>">Edit</a>
    ...
    <div class="card-body" id="out_print">
        ...
        <div class="row mb-2">
            <div class="col-6">
                ...
                ?>
                <div>
                    <p class="m-0"><?php echo $vendor['vendor_name'] ?></p>
                    <p class="m-0"><?php echo $vendor['address'] ?></p>
                    <!-- <p class="m-0"><//?php echo $vendor['contact_person'] ?></p> -->
                    <p class="m-0"><?php echo $vendor['contact'] ?></p>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="po-item" data-id="">
                                    <td class="align-middle p-0 text-center"><?php echo $row['material_id'] ?></td>
                                    <td class="align-middle p-1"><?php echo $row['material_name'] ?></td>
                                    <td class="align-middle p-1"><?php echo $row['quantity'] ?></td>
                                    <td class="align-middle p-1 item-description"><?php echo $row['price'] ?></td>
