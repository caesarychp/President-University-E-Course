        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT r.*,c.category,c.balance from `running_balance` r inner join `categories_expenses` c on r.category_id = c.id where c.status=1 and r.balance_type = 1 order by unix_timestamp(r.date_created) asc");
