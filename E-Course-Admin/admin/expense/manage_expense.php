    ...
    <form action="" id="expense-form">
        ...
        <?php if (!isset($id)) : ?>
            <div class="form-group">
                ...
                <select name="category_id" id="category_id" class="custom-select select2" required>
                    <option value=""></option>
                    <?php
                    $qry = $conn->query("SELECT * FROM `categories_expenses` where `balance` > 0 order by category asc");
        ...
        <?php else : ?>
            <div class="form-group">
                ...
                <?php
                $qry = $conn->query("SELECT * FROM `categories_expenses` where id = '{$category_id}'");
