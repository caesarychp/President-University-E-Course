...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
    $weeks[] = [
      ...
      "url" => "http://localhost:8080/eBusiness/webiste/pages/learn.php?week_id=" . $row['week_id']
    ];
  }
}
...
// Define other items
$otherItems = [
  ["icon" => "bi bi-chat-left-text-fill", "text" => "Mentor Chat", "link" => "http://localhost:8080/eBusiness/webiste/pages/mentorchat.php"],
  ["icon" => "bi bi-bookmark-fill", "text" => "Certificate", "link" => "http://localhost:8080/eBusiness/webiste/pages/Certificate.php"]
];
