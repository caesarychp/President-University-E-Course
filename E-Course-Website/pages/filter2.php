...
<head>
    ...
    <link rel="stylesheet" href="./css/bearstyle.css">
</head>
...
<body>
    ...
    <main class="page-container">
        <header class="header">
            ...
            $logoSrc = "../assets/images/courses/site_logo.png";
            $puLogoSrc = "../assets/images/courses/presuniv_logo.png";
            $searchIconSrc = "../assets/images/courses/search_icon.png";
            ?>
            <img src="<?php echo $logoSrc; ?>" alt="Logo" class="logo">
            <div class="site-title">
                <img src="<?php echo $puLogoSrc; ?>" alt="PU Logo" class="site-logo">
                <div class="site-name">
            ...
            <div class="search-container">
                <form class="search-bar">
                    <img src="<?php echo $searchIconSrc; ?>" alt="Search Icon" class="search-icon">
    ...
    <div class="card-container" id="card-container">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                echo '<div class="card">';
                echo '<img src="../assets/images/filter/' . $row["img"] . '">';
                ...
                echo '<a href="http://localhost:8080/eBusiness\webiste\pages\detail_courses.php?course_id=' . $row["course_id"] . '" class="btn">Read More</a>';
                // echo '<a href="http://localhost:8080/eBusiness\webiste\pages\detail_courses.php' . $row["course_id"] . '" class="btn">Read More</a>';
