...
<body>
    ...
    if (isset($_GET['course_id'])) {
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            $img = "../assets/images/filter/" . $row['img']; // Adjust the path as needed
            // $img = $row['img'];
    ...
    <header class="header">
        <div class="header-top">
            <a href="http://localhost:8080/eBusiness/webiste/pages/filter2.php">
                <button class="menu-button">☰ VIEW ALL COURSES</button>
            </a>
            <div class="logo-container">
                <img src="../assets/images/courses_detail/President_University_Logo.png" alt="President University Logo" class="university-logo">
                <a href="http://localhost:8080/eBusiness/webiste/pages/homepage.php"><span style="color: white;">President University <br> E-Course</span></a>
            </div>
        ...
        <div class="header-main">
            <div class="header-content">
                ...
                <!-- <a href="http://localhost:8080/eBusiness/webiste/pages/filter2.php" class="learn-more-btn">LEARN</a> -->
                <a href="http://localhost:8080/eBusiness/webiste/pages/learn.php?course_id=<?= $course_id ?>&week_id=1" class="learn-more-btn">LEARN</a>
                <!-- <a href="http://localhost:8080/eBusiness/webiste/pages/learn.php?course_id=<?= $course_id ?>" class="learn-more-btn">LEARN</a> -->
    ...
    <main class="course-main">
        ...
        <aside class="course-sidebar">
            ...
            <div class="logo-container-sidebar">
                <img src="../assets/images/courses_detail/President_University_Logo.png" alt="President University Logo" class="sidebar-logo">
            </div>
            <div class="sidebar-section">
    ...
    <section class="lectures-section">
        ...
        <div class="lecturer-info">
            <img src="../assets/images/courses_detail/Person.png" alt="Stanley Y. Shaw" class="lecturer-image">
    ...
    <section class="recommendations-section">
        ...
        <div class="course-cards-container">
            <article class="course-card">
                <img src="../assets/images/courses_detail/1.png" alt="Community Health Worker" class="course-image">
            ...
            <article class="course-card">
                <img src="../assets/images/courses_detail/2.png" alt="Community Health Worker" class="course-image">
                <div class="course-info">
                    <h3 class="course-category">HEALTH & MEDICINE</h3>
                    <p class="course-delivery">ONLINE</p>
            ...
            <article class="course-card">
                <img src="../assets/images/courses_detail/3.png" alt="Community Health Worker" class="course-image">
                <div class="course-info">
                    <h3 class="course-category">HEALTH & MEDICINE</h3>
    ...
    <footer class="site-footer">
        <div class="footer-content">
            <div class="footer-logo">
                <img src="../assets/images/courses_detail/President_University_Logo.png" alt="President University Logo" class="footer-university-logo">
