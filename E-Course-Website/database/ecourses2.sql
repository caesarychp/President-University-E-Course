...
(10, 59, 'INV-7', '2024-05-13', '2024-06-12', 500000.00, 0.00, '2024-05-15', 'Open', NULL),
(11, 60, 'INV-17', '2024-05-14', '2024-06-13', 1000000.00, 0.00, '2024-05-15', 'Closed', NULL),
(12, 6, 'INV-6', '2024-05-14', '2024-06-13', 800000.00, 0.00, NULL, 'Closed', NULL),
(13, 61, 'INV-89', '2024-05-15', '2024-06-14', 1090512.00, 0.00, NULL, 'Open', NULL),
(14, 1, 'INV-1', '2024-05-15', '2024-06-14', 600000.00, 0.00, NULL, 'Open', NULL),
(15, 63, 'INV-40', '2024-05-15', '2024-06-14', 400000.00, 0.00, '2024-05-15', 'Closed', NULL);
...
(18, 'ebusiness', 'ioijadjadlj', 3, 11, 1002, '66447cbb1b5e5_2022-02-25 (1).png', '2024-05-17', 'Free', '3 weeks', 'Beginner', '2-4 hours per week', 'English', 'skjcnkfd');
...
(8, 'Caesar', 'admin@admin.com', '1234567890', 'jalan', 3, '2cf1a05395bd9d1d9da5fb9147909fc7');
...
(6, 13, 'Pending', '2024-05-15 16:19:01');
...
(13, 1, 1, '129379', '0000-00-00', '123123231', '2024-05-15 16:19:01', 29000.00);
...
(1, '1', 1, 1001, 2, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 300000, '2024-04-01 00:00:00', '2024-05-15 16:26:18', 1),
...
(62, '56', 12, 1002, 12, '', 50000, '2024-05-15 16:25:25', NULL, 0),
(63, '40', 6, 1003, 20, '', 20000, '2024-05-15 16:31:56', '2024-05-15 16:32:22', 1);
...
(19, 59, 2, 14, '2024-05-20', '2024-05-15 16:26:26'),
(20, 60, 1, 11, '2024-05-21', '2024-05-15 16:26:44'),
(21, 6, 1, 0, '2024-05-21', '2024-05-15 17:27:13'),
(22, 61, 1, 11, '2024-05-22', '2024-05-15 16:26:31'),
(23, 1, 1, 14, '2024-05-22', '2024-05-15 17:29:06'),
(24, 63, 0, 1, '2024-05-22', NULL);
...
(18, 6, 2, 1, 18000, '6', '', '2024-05-15 15:25:47', NULL),
(19, 5, 2, 1, 1000, '5', '', '2024-05-15 16:38:06', '2024-05-15 16:39:48');
...
(3, '2024-03-27 15:41:52', 29000.00, 3, 3, 'Active', 2),
(4, '2024-03-27 15:41:53', 29000.00, 1, 4, 'Active', 2),
(5, '2024-03-27 15:41:53', 29000.00, 2, 5, 'Processing', 2);
...
(12, 'ingridd', 'ingd', 'diffdsijkj@gmail.com', 'kjdfnaskjf', '093480985', '2024-05-15 16:24:29', 1);
...
--
ALTER TABLE `accountable_receivable`
  MODIFY `ReceivableID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `databanks`
  MODIFY `DatabankID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `purchase_order`
  MODIFY `po_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `receive_goods`
  MODIFY `receive_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `accounts_payable`
  ADD CONSTRAINT `accounts_payable_ibfk_1` FOREIGN KEY (`po_id`) REFERENCES `purchase_order` (`po_id`);
